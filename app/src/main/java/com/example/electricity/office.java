...
public class office extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try
        {
            myReff = myReff.child("messages").child("office");
        ...
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(getActivity(), "Messages To Customer", Toast.LENGTH_SHORT).show();

                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.time_wrapper, new message(), "findThisFragment")
                        .addToBackStack(null)
                        .commit();
            }
        });
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            case R.id.send:
                ...
                EditText txt = office.this.getView().findViewById(R.id.typemesg);
                ...
                if(!txt.equals("")){
                    ...
                    try {
                        ...
                        myRef.child("messages").child("office").child(currentDateandTime).child(hey).setValue(typemesg.getText().toString());
                        txt.setText("");
                    } catch (Exception e) {
